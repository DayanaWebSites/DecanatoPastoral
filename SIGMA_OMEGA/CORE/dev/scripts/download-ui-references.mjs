 ...
 *
 * Uso: node SIGMA_OMEGA/CORE/dev/scripts/download-ui-references.mjs
 */
...
const logo = join(raiz, 'apps/web/src/assets/decanato/logo-claro.webp');
if (existsSync(logo)) {
...
Fuente de tokens: \`apps/web/src/styles/global.css\` bloque \`@theme\`.
